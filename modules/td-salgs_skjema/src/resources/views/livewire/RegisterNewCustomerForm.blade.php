            ...
            <div class="container m-3 border-bottom">
                ...
                <div class="row mt-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="orgName" placeholder="Bedriftens navn">
                    </div>
                </div>
        ...
        <div class="container m-3 border-bottom">
                ...
                <div class="row mt-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="kontaktNavn" placeholder="Kundens navn">
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="kontaktEpost" placeholder="ola@nordman.no">
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="kontaktTlf" placeholder="ola@nordman.no">
                    </div>
                </div>
        </div>
            ...
            <div class="container m-3">
                ...
                @if($business == true)
                    <div class="row mt-3">
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="ehf">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-8">
                            <div class="mb-1">
                                ...
                                <input type="mail" class="form-control" id="faktepost" placeholder="post@bedrift.no">
                            </div>
                        </div>
                    </div>
                @endif
