...
<li class="list-group-item list-group-item-action {{ in_array($item->id, $activeMenuIds) ? 'active' : '' }}" style="padding-left: {{ $level * 20 }}px;">
    ...
    -->
    <a href="{{ $item->url }}" wire:click.prevent="toggleMenu({{ $item->id }}, '{{ $item->url }}')">
